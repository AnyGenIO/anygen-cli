...
```bash
anygen task +run --operation deep_research --prompt <text> [flags]
```
...
Run `anygen task +run --operation deep_research --prompt '...' --output-dir ./output` in the background.
